...
// console.log(previewText);
  ...
  return (
    <div className="search-brands__app" onClick={() => {handleOpen(); previewGet()}} onMouseLeave={handleClose}>
      ...
      <ShowSvg onClick={clear} className={`button-search__svg ${filterText==='' ? 'show' : 'hidden'}`}/>
