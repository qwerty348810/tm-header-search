  ...
  return(
      <>
      {
        previewText.map((previewText, index) => {
          return (
            <a className="brand-item__content" href={"getChannelUrl"+previewText.username} key={index}>
  ...
  <>
    {
      listServer.map((listServer, index) => {
        return (
          <a className="brand-item__content" href={"getChannelUrl"+listServer.username} key={index}>
            <picture className="brand-item__picture">
...
if(filterText!=='' && listServer.length===0)
  return(
      <>
      {
          <div className="brand-item__content phrase-sorry">
            <div className="brand-item__description" >
